...
from xai.common.sftp.PySFTPClient import PySFTPClient
from xai.common.utils.ImageUtils import ImageUtils
...
if __name__ == '__main__':
    ...
    gee = sm.load_json_oneline("/eyeCloudAI/data/processing/ape/division/99429867778487988_0.done", "1")
