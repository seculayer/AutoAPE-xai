...
ARG APP_DIR="/opt/app"
ARG CLOUD_AI_DIR="/eyeCloudAI/app/ape/xai/"
...
COPY --chown=aiuser:aiuser xai ${CLOUD_AI_DIR}/xai
COPY --chown=aiuser:aiuser xai.sh ${CLOUD_AI_DIR}
RUN chmod +x ${CLOUD_AI_DIR}/xai.sh
